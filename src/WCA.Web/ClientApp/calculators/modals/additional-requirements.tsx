...
export default class AdditionalRequirements extends React.Component<AppProps, AppStates> {
            ...
            <div className="modal-body">
                <div className="ms-Grid" dir="ltr">
                    ...
                    <div className="ms-Grid-row modal-row">
                        <div className="ms-Grid-col ms-sm4">Description : </div>
                    ...
                    <div className="ms-Grid-row modal-row">
                        <div className="ms-Grid-col ms-sm4">Amount : </div>
                        <div className="ms-Grid-col ms-sm8">
                            <TextField
