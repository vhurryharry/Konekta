...
describe("Testing Settlement Calculator for NSW(Save)", () => {

    it('Navigate to the Calculator', () => {
        cy.login("trial181078920", 21);
    ...
    it("Water Usage", () => {
        ...
        cy.get("[data-cy='adjustment_result_1']").should("have.text", "12,057.93");
    })
    ...
    it("Emergency Services Levy", () => {
        ...
        cy.get("[data-cy='adjustment_result_2']").should("have.text", "7,564.10");
    })
    ...
    it("Penalty Interest", () => {
        ...
        cy.get("[data-cy='adjustment_result_3']").should("have.text", "21,369.86");
    })
    ...
    it("Save settlement", () => {
        ...
        cy.get("button[data-cy='save_button']").click();
    })
    ...
    it("Confirm modal", () => {
        ...
        cy.get("body").find("[data-cy='modal-header']").should("have.length", 2);
        cy.get("[data-cy='use_old_button']").click();
    })
    ...
    it("Other Adjustment Fixed", () => {
        ...
        cy.get("[data-cy='adjustment_result_4']").should("have.text", "1,500.00");
    })
    ...
    it("Other Adjustment Date", () => {
        ...
        cy.get("[data-cy='adjustment_result_5']").should("have.text", "-1,025.64");
    })
    ...
    it("Check the payee result", () => {
        cy.get("[data-cy='contract_debit_value']").should("have.text", "46,844.22");
        cy.get("[data-cy='contract_credit_value']").should("have.text", "24,622.04");

        cy.get("[data-cy='additional_debit_value']").should("have.text", "$49,344.22");
        cy.get("[data-cy='additional_credit_value']").should("have.text", "$24,622.04");

        cy.get("[data-cy='allocated_debit_value']").should("have.text", "$46,844.22");
        cy.get("[data-cy='allocated_credit_value']").should("have.text", "$46,844.22");
