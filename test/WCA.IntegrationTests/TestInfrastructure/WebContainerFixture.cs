...
namespace WCA.IntegrationTests.TestInfrastructure
{
    public class WebContainerFixture : IDisposable
    {
        ...
        public WebContainerFixture()
        {
            ...
            // IEventStore is a singleton so we don't need to create a scope
            var eventStore = _host.Services.GetService<IEventStore>();
            eventStore.DangerPurgeAllEvents();
        }
